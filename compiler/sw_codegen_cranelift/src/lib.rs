...
fn extern_c_symbol(name: &str) -> &str {
    match name {
        ...
        "run_with_env" => "sw_run_with_env",
        "run_in_dir" => "sw_run_in_dir",
        "run_stdout_stderr" => "sw_run_stdout_stderr",
        "is_process_running" => "sw_is_process_running",
        "process_open" => "sw_process_open",
        "process_write" => "sw_process_write",
        "process_read_line" => "sw_process_read_line",
        "process_read_some" => "sw_process_read_some",
        "process_poll" => "sw_process_poll",
        "process_wait" => "sw_process_wait",
        "process_kill" => "sw_process_kill",
        "process_close" => "sw_process_close",
        "process_close_input" => "sw_process_close_input",
        "read_key" => "sw_read_key",
        ...
        "pause" => "sw_pause",
        "print_format" => "sw_print_format",
        "格式化输出" => "sw_print_format",
        "flush" => "sw_flush",
        "console_clear_line" => "sw_console_clear_line",
        "console_title" => "sw_console_title",
        "memory_usage_kb" => "sw_memory_usage_kb",
        "edit_distance" => "edit_distance",
        "console_color" => "sw_console_color",
        "console_reset" => "sw_console_reset",
        "console_clear" => "sw_console_clear",
        "console_gotoxy" => "sw_console_gotoxy",
        "console_hide_cursor" => "sw_console_hide_cursor",
        "console_show_cursor" => "sw_console_show_cursor",
        "getch" => "sw_getch",
        "console_width" => "sw_console_width",
        "console_height" => "sw_console_height",
        "cwd" => "sw_cwd",
        "chdir" => "sw_chdir",
        ...
        "html_unescape" => "sw_html_unescape",
        "base32_encode" => "sw_base32_encode",
        "base32_decode" => "sw_base32_decode",
        "is_cjk" => "sw_is_cjk",
        "is_letter" => "sw_is_letter",
        "is_digit" => "sw_is_digit",
        "char_width" => "sw_char_width",
        "sort_int" => "sw_sort_int",
        "sort_float" => "sw_sort_float",
        "sort_string" => "sw_sort_string",
        "sort_int_desc" => "sw_sort_int_desc",
        "sort_float_desc" => "sw_sort_float_desc",
        "sort_string_desc" => "sw_sort_string_desc",
        ...
        "concat_int" => "sw_array_concat_int",
        "concat_float" => "sw_array_concat_float",
        "concat_string" => "sw_array_concat_str",
        "insert_int" => "sw_array_insert_int",
        "insert_float" => "sw_array_insert_float",
        "insert_string" => "sw_array_insert_str",
        "remove_at_int" => "sw_array_remove_at_int",
        "remove_at_float" => "sw_array_remove_at_float",
        "remove_at_string" => "sw_array_remove_at_str",
        "unique_int" => "sw_array_unique_int",
        "unique_float" => "sw_array_unique_float",
        "min_index_float" => "sw_min_index_float",
        "max_index_float" => "sw_max_index_float",
        "map_new" => "sw_map_new",
        "map_set" => "sw_map_set",
        "map_get" => "sw_map_get",
        "map_has" => "sw_map_has",
        ...
        "map_set_int" => "sw_map_set_int",
        "map_get_int" => "sw_map_get_int",
        "map_inc" => "sw_map_inc",
        "map_set_float" => "sw_map_set_float",
        "map_get_float" => "sw_map_get_float",
        "map_set_bool" => "sw_map_set_bool",
        "map_get_bool" => "sw_map_get_bool",
        ...
        "url_parse" => "url_parse",
        "url_query" => "url_query",
        "url_build_query" => "url_build_query",
        "http_get" => "http_get",
        "http_post" => "http_post",
        "http_get_timeout" => "http_get_timeout",
        "http_post_timeout" => "http_post_timeout",
        "http_open" => "sw_http_open",
        "http_open_timeout" => "sw_http_open_timeout",
        "http_request_on" => "sw_http_request_on",
        "http_close" => "sw_http_close",
        "rand_int_range" => "rand_int_range",
        "rand_bool" => "rand_bool",
        "random_uuid" => "random_uuid",
        "shuffle_string" => "sw_shuffle",
        "shuffle_int" => "sw_shuffle",
        "shuffle_float" => "sw_shuffle",
        "format_bytes" => "format_bytes",
        "format_thousands" => "format_thousands",
        "int_to_hex" => "int_to_hex",
        "int_to_oct" => "int_to_oct",
        "int_to_bin" => "int_to_bin",
        "parse_int_radix" => "parse_int_radix",
        ...
        "csv_join" => "csv_join",
        "datetime_string_ms" => "datetime_string_ms",
        "week_of_year" => "week_of_year",
        "write_lines" => "write_lines",
        "temp_file_path" => "temp_file_path",
        "temp_file_create" => "temp_file_create",
        "random_bytes" => "sw_random_bytes",
        "log_runtime_set_level" => "sw_log_set_level",
        ...
        "arr_range" => "arr_range",
        "arr_fill" => "arr_fill",
        "arr_count_int" => "arr_count_int",
        "arr_avg_int" => "arr_avg_int",
        "utc_year_of" => "utc_year_of",
        "utc_month_of" => "utc_month_of",
        "utc_day_of" => "utc_day_of",
        "utc_hour_of" => "utc_hour_of",
        "utc_minute_of" => "utc_minute_of",
        "utc_second_of" => "utc_second_of",
        "utc_weekday_of" => "utc_weekday_of",
        ...
        "json_string_new" => "json_string_new",
        "json_int_new" => "json_int_new",
        "json_float_new" => "json_float_new",
        "json_bool_new" => "json_bool_new",
        "json_null_new" => "json_null_new",
        "json_object_set" => "json_object_set",
        "json_array_append" => "json_array_append",
        "render_template" => "render_template",
        "format_table" => "format_table",
        "last_index_of_string" => "last_index_of_string",
        "last_index_of_int" => "last_index_of_int",
        "last_index_of_float" => "last_index_of_float",
        "min_index_int" => "min_index_int",
        "max_index_int" => "max_index_int",
        "zip_strings" => "zip_strings",
        ...
        "net_resolve" => "sw_net_resolve",
        "net_peer_ip" => "sw_net_peer_ip",
        "net_peer_port" => "sw_net_peer_port",
        "net_set_keepalive" => "sw_net_set_keepalive",
        "net_recv_until_close" => "sw_net_recv_until_close",
        "net_send_all" => "sw_net_send_all",
        "crc32" => "crc32",
